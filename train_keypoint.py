...
def train(hyp, opt, device, tb_writer=None):
    ...
    with open(opt.cfg) as f:
        data_dict_cfg = yaml.safe_load(f)  # data dict
    ...
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, opt,
                                            ...
                                            image_weights=opt.image_weights, quad=opt.quad, prefix=colorstr('train: '), kpt_label=kpt_label, kpt_num = nkpt)
    ...
    if rank in [-1, 0]:
        testloader = create_dataloader(test_path, imgsz_test, batch_size * 2, gs, opt,  # testloader
                                       ...
                                       world_size=opt.world_size, workers=opt.workers,
                                       pad=0.5, prefix=colorstr('val: '), kpt_label=kpt_label, kpt_num = nkpt)[0]
